...
GLuint GameUtil::LoadTexture(const char* filePath) {
    int w, h, n;
...
void GameUtil::DrawText(ShaderProgram* shaderProgram, GLuint fontTexture, std::string text, float size, float spacing, glm::vec3 position) {
